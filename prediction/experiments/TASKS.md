...
- [ ] T1.1 — Build `prediction/experiments/harness.py`: loads imputation outputs, defines expanding-window folds (grouped by CMA) ONCE, computes MDA/NMSE/NRMSE/NMAE via evaluation.py, writes runs.jsonl rows
